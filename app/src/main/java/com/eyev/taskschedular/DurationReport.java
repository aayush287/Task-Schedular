...
public class DurationReport extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>,
    ...
    private static final String TAG = "DurationReport";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null){
            long timeInMills = savedInstanceState.getLong(CURRENT_DATE, 0);
            if (timeInMills != 0){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.rm_filter_date:
                showDatePickerDialog(getString(R.string.date_filter), DIALOG_FILTER);  // The actual filtering is done in onDateSet()
                return true;
            case R.id.rm_delete:
                showDatePickerDialog(getString(R.string.date_delete), DIALOG_DELETE);  // The actual deletion is done in onDateSet()
                return true;
        }
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        ...
        switch (dialogId){
            ...
            case DIALOG_DELETE:
                ...
                args.putString(AppDialog.DIALOG_MESSAGE, getString(R.string.delete_message, fromDate));
   ...
   private void deleteRecords(long timeInMillis){
    ...
    private void applyFilter(){
        ...
        if (mDisplayWeek){
            ...
            // we have a date, so find which day in the week it is
            ...
            Log.d(TAG, "applyFilter: day of the week is "+dayOfWeek);
