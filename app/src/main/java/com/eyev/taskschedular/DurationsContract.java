...
public class DurationsContract {
    ...
    public static class Columns{
        ...
        public static final String DURATIONS_NAME = TaskContract.Columns.TASKS_NAMES;
        public static final String DURATIONS_DESCRIPTION = TaskContract.Columns.TASKS_DESCRIPTION;
    ...
    /**
     * The URI to access the Duration view.
     */
